...
public:
    // Hook function for the predictor. calls SetOutPort on message
    // Without incurring extra latency for using the control line
    void PredictorSetOutPort(NoCFlitMsg *msg);
};
